# Pièce — Thread 6 / email-295 (Élise → LP, 16 sept. 2016, 16:07 UTC)

> **Source de vérité.** `Email` id=295, `EmailThread` id=6. Date base : 2016-09-16 16:07:54 UTC (≈ 12:07 EDT). Expéditeur : Élise Ayoub.

---

## C1 — Refus de la garde partagée = incapacité de communication (non dangerosité)
...
Verbatim (email-295, même message) :
...
**Contextes d'usage :**
- §30-31 (fait 13) : opposition à la garde partagée qualifiée de simple désaccord / incompréhension mutuelle — non de mesure de protection.
