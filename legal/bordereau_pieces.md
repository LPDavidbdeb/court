...
## Pièces de soutien — preuve de volume (en liasse, art. 2855 C.c.Q.)

Réfutent les allégations **structurelles** de désengagement (Requête 2015, stmts 8-11, 19-21). Détail et paragraphes de densité : [preuve_volume_implication_pere.md](preuve_volume_implication_pere.md).

| Cote | Axe | Fichier |
|---|---|---|
| S-1 | Présence quotidienne (parc, activités, milieu paternel) | axe_presence_quotidienne_activites |
| S-2 | Coordination garderie / école | axe_garderie_coordination |
| S-3 | Activités des enfants (division des tâches) | axe_activites_enfants |
| S-4 | Absences au travail (enfants malades) — courriels BNC | axe_absences_travail_enfants_malades |
| S-5 | Agenda de danse d'Élise (indisponibilité) | axe_agenda_danse_elise |
| S-6 | Fracture relationnelle nov. 2010 (contexte) | axe_fracture_relationnelle_nov2010 |
| S-7 | Âge des enfants (couche transversale) | axe_age_enfants_vulnerabilite |
