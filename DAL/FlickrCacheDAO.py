...
class FlickrCachDAO:
    def __init__(self, account_name):
        ...
        self.cache_base_dir = os.path.join("storage", "photos", "Flickrs", self.account_name)
        os.makedirs(self.cache_base_dir, exist_ok=True)

    def get_cache_filepath(self, album_title: str) -> str:
        """Returns a full path to the cache file, e.g., storage/photos/Flickrs/cchic/albumname_20250711.pkl"""
